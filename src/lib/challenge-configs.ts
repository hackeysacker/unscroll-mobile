...
export const CHALLENGE_CONFIGS: Record<ChallengeType, ChallengeConfig> = {
  ...
  look_away: {
    name: 'Look Away',
    icon: '🙈',
    description: 'Practice looking away from the screen to reduce screen dependency and eye strain. Build the ability to disconnect.',
    duration: 30,
    xpReward: 10,
    difficulty: 'easy',
    instructions: [
      'Tilt your device away or face down',
      'Look away from the screen',
      'Hold for the full duration',
      'Resist the urge to check the screen',
    ],
    benefits: [
      'Reduces screen dependency',
      'Improves eye health',
      'Builds disconnect discipline',
  ...
  anti_scroll_swipe: {
    name: 'Anti-Scroll Swipe',
    icon: '🚫',
    description: 'Resist the urge to scroll through enticing content. Build resistance to infinite scroll patterns.',
    duration: 45,
    xpReward: 15,
    difficulty: 'medium',
    instructions: [
      'Content will appear on screen',
      'DO NOT scroll or swipe',
      'Resist for the full duration',
      'Any scrolling reduces your score',
    ],
    benefits: [
      'Breaks scroll addiction',
      'Improves impulse control',
  ...
  reset: {
    ...
    instructions: [
      ...
      'Prove your complete attention mastery',
    ],
    benefits: [
      'Tests all attention skills',
      'Proves mastery level',
      'Ultimate focus challenge',
  ...
  reset_challenge: {
    ...
    icon: '🔄',
    description: 'Dev testing challenge for reset functionality.',
    duration: 30,
    xpReward: 5,
    difficulty: 'easy',
    instructions: ['Test reset'],
    benefits: ['Testing'],
    colors: {
      background: '#1a1a2e',
      primary: '#6366F1',
  ...
  logic_puzzle: {
    name: 'Logic Puzzle',
    icon: '🧩',
    description: 'Solve logic puzzles to train problem-solving and focused thinking.',
    duration: 90,
    xpReward: 20,
    difficulty: 'medium',
    instructions: ['Analyze the pattern', 'Find the solution'],
    benefits: ['Improves logical thinking', 'Enhances problem-solving'],
    colors: {
      background: '#1a1a2e',
      primary: '#8B5CF6',
      secondary: '#7C3AED',
  ...
  memory_puzzle: {
    name: 'Memory Puzzle',
    icon: '🧠',
    description: 'Test and strengthen your working memory with pattern recall challenges.',
    duration: 60,
    xpReward: 15,
    difficulty: 'medium',
    instructions: ['Remember the pattern', 'Recall it accurately'],
    benefits: ['Improves memory', 'Enhances recall'],
    colors: {
      background: '#1a1a2e',
      primary: '#06B6D4',
      secondary: '#0891B2',
  ...
  distraction_resistance: {
    ...
    icon: '🛡️',
    description: 'Train your ability to stay focused despite interruptions and distractions.',
    duration: 45,
    xpReward: 15,
    difficulty: 'hard',
    instructions: ['Stay focused', 'Ignore distractions'],
    benefits: ['Builds mental resilience', 'Improves concentration'],
    colors: {
      background: '#1a1a2e',
      primary: '#EF4444',
      secondary: '#DC2626',
  ...
  audio_focus: {
    name: 'Audio Focus',
    icon: '🎧',
    description: 'Train your ability to focus on audio content while ignoring background noise.',
    duration: 60,
    xpReward: 15,
    difficulty: 'medium',
    instructions: ['Listen carefully', 'Ignore background sounds'],
    benefits: ['Improves auditory focus', 'Enhances concentration'],
    colors: {
      background: '#1a1a2e',
      primary: '#8B5CF6',
      secondary: '#7C3AED',
  ...
  impulse_delay: {
    name: 'Impulse Delay',
    icon: '⏳',
    description: 'Train your ability to delay responding to impulses and urges.',
    duration: 45,
    xpReward: 15,
    difficulty: 'hard',
    instructions: ['Wait before acting', 'Observe the impulse'],
    benefits: ['Builds impulse control', 'Improves self-regulation'],
    colors: {
      background: '#1a1a2e',
      primary: '#F59E0B',
      secondary: '#D97706',
  ...
  stability_hold: {
    name: 'Stability Hold',
    icon: '🎯',
    description: 'Maintain focus on a stable target while resisting distractions.',
    duration: 60,
    xpReward: 15,
    difficulty: 'medium',
    instructions: ['Focus on the target', 'Resist distractions'],
    benefits: ['Improves focus stability', 'Builds attention endurance'],
    colors: {
      background: '#1a1a2e',
      primary: '#10B981',
      secondary: '#059669',
