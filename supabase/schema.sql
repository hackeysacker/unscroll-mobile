-- =============================================================================
-- UNSCROLL (FOCUSFLOW) DATABASE SCHEMA
-- =============================================================================
-- Last Updated: February 20, 2026
-- Project: Unscroll/FocusFlow iOS App
-- Backend: Supabase (PostgreSQL)
--
-- This schema defines all tables, indexes, RLS policies, and triggers
-- needed for the FocusFlow attention training app.
--
-- To deploy: Run this entire file in Supabase SQL Editor
-- =============================================================================
...
-- User Onboarding: Stores initial user setup data
...
-- =============================================================================
-- SECTION 2: GAMEPLAY TABLES
-- =============================================================================

-- Game Progress: Level, XP, streaks, session tracking
...
-- Skill Progress: Three core skill metrics
...
-- Challenge Results: Individual exercise/game completions
...
-- Daily Sessions: One row per user per day
...
-- =============================================================================
-- SECTION 3: HEARTS SYSTEM (Lives)
-- =============================================================================

-- Heart State: Current hearts, max hearts, streaks
...
-- Heart Refill Slots: Scheduled heart refills (3 slots)
...
-- Heart Transactions: Audit log for heart changes
...
-- Badge Progress: Progress toward unlocking badges
...
-- =============================================================================
-- SECTION 5: PROGRESS TREE (Skill Map)
-- =============================================================================

-- Progress Tree State: Overall tree unlock state
...
-- Progress Nodes: Individual node completion status
...
-- User Themes: Custom color themes
...
-- Training Plans: User's active training programs
...
-- Training Recommendations: AI-generated exercise suggestions
...
-- Wind Down Sessions: Evening relaxation sessions
...
-- Wind Down Settings: User preferences for wind down feature
...
-- Deep Analytics: Aggregated insights and trends
...
-- Analytics Data Points: Individual metric recordings
...
-- =============================================================================
-- SECTION 12: AUTO-CREATE USER RECORDS ON SIGNUP
-- =============================================================================

-- Function: Creates default records for new users
...
-- Trigger: Run handle_new_user() when new user signs up
